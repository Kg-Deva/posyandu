class BalitaHandler {
  ...
  initializeZScoreData() {
    ...
    this.zscoreTBU = [
      // ✅ UMUR 0-11 BULAN (TETAP SAMA - SUDAH BENAR)
      {
        umur: 0,
        median: 49.9,
        sd3: 44.2,
      ...
      // ✅ UMUR 12-23 BULAN (TETAP SAMA - SUDAH BENAR)
      {
        umur: 12,
        median: 75.7,
        sd3: 68.4,
      ...
      // ✅ UMUR 24-35 BULAN (TETAP SAMA - SUDAH BENAR)
      {
        umur: 24,
        median: 92.1,
        sd3: 85.0,
      ...
      // ✅ UMUR 36-47 BULAN (PERBAIKAN - KONSISTEN DENGAN POLA YANG WAJAR)
      {
        umur: 36,
        median: 102.7,
        sd3: 95.9,
      ...
      // ✅ UMUR 48-54 BULAN (PERBAIKAN - KONSISTEN DENGAN POLA YANG WAJAR)
      {
        umur: 48,
        median: 109.9,
        sd3: 103.1,
      ...
      // ✅ UMUR 55-60 BULAN (PERBAIKAN - KONSISTEN DENGAN POLA YANG WAJAR)
      {
        umur: 55,
        median: 114.1,
        sd3: 107.3,
