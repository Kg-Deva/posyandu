                    ...
                    <div class="card mb-4">
                        <section class="section d-flex justify-content-center align-items-center flex-grow-1">
                            <div class="card w-100 w-md-30 w-lg-20">
                                <form action="{{ route('simpan-beranda') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                    ...
                                    <div class="card-content">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="tagline" class="form-control" name="tagline" placeholder="Masukan Tagline"required >
                                            @error('tagline')
                                    ...
                                    <div class="card-content">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="deskripsi" class="form-control" name="deskripsi" placeholder="Masukan Deskripsi" required>
                                            @error('deskripsi')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="card-content">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="helpInputTop"
                                                placeholder="Masukan tautan google maps" name="maps" required>
                                        </div>
                                    </div>
