                    ...
                    <div class="card mb-4">
                        <section class="section d-flex justify-content-center align-items-center flex-grow-1">
                            <div class="card w-100 w-md-30 w-lg-20">
                                <form  action="{{ url('update-ekstra', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ekstra') is-invalid @enderror" id="ekstra" name="ekstra" value="{!! $data['ekstra'] !!}" required >
                                        @error('ekstra')
