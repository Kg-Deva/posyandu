                                ...
                                <form action="{{ route('simpan-kontak') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('whatsapp') is-invalid @enderror" id="Whatsapp" name="whatsapp" value="{{ old('whatsapp') }}" required onkeypress="return hanyaAngka(event)">
                                            @error('whatsapp')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" value="{{ old('no_telp') }}" required onkeypress="return hanyaAngka(event)">
                                            @error('no_telp')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
