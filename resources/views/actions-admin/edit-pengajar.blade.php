                    ...
                    <div class="card mb-4">
                        <section class="section d-flex justify-content-center align-items-center flex-grow-1">
                            <div class="card w-100 w-md-30 w-lg-20">
                                <form class="mb-3" action="{{ url('update-profilpengajar', $data->id) }}"
                                    ...
                                    <div class="card-content">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namaGuru"
                                                placeholder="Masukkan nama guru" name="pengajar"  value="{!! $data['pengajar'] !!}">
                                        </div>
                                        @error('pengajar')
                                    ...
                                    <div class="card-content">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="jabatanGuru" name="jabatan"
                                                placeholder="Masukkan jabatan guru"  value="{!! $data['jabatan'] !!}">
                                        </div>
                                        @error('jabatan')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
