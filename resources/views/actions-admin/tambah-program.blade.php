        ...
        <div id="main">
            ...
            <div class="section d-flex justify-content-center align-items-center flex-grow-1">
                ...
                <div class="page-heading">
                    <h3>Tambah Program Pendidikan</h3>
                </div>
            </div>
                    ...
                    <div class="card mb-4">
                        <section class="section d-flex justify-content-center align-items-center flex-grow-1">
                            <div class="card w-100 w-md-30 w-lg-20">
                                <form action="{{ route('simpan-program') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <!-- Whatsapp -->
                                        <div class="mb-3">
                                            <label for="materi" class="form-label">Program</label>
                                            <input type="text" class="form-control @error('materi') is-invalid @enderror" id="materi" name="materi" value="{{ old('materi') }}" required >
                                            @error('materi')
