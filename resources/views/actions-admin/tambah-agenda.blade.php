                                ...
                                <form action="{{ route('simpan-agenda') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judulAgenda" name="judul" value="{{ old('judul') }}" required>
                                            @error('judul')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsiAgenda" name="deskripsi" rows="3" required>{{ old('deskripsi') }}</textarea>
                                            @error('deskripsi')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('penulis') is-invalid @enderror" id="penulisAgenda" name="penulis" value="Admin" required readonly placeholder="Admin">
                                            @error('penulis')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
