                    ...
                    <div class="card mb-4">
                        <section class="section d-flex justify-content-center align-items-center flex-grow-1">
                            <div class="card w-100 w-md-30 w-lg-20">
                                <form  action="{{ url('update-berita', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                <div class="card-body">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="deskripsiBerita" name="deskripsi" rows="3" required>{{ old('deskripsi', $data->deskripsi) }}</textarea>
                                    </div>
                                    <!-- Tanggal Berita -->
                                    <div class="mb-3">
                                        <label for="tanggalBerita" class="form-label">Tanggal Berita</label>
                                        <input type="date" class="form-control" id="tanggalBerita" name="tanggal"
                                            required value="{!! $data['tanggal'] !!}">
                                    </div>
                                    <!-- Penulis Berita -->
                                    <div class="mb-3">
                                        <label for="penulisBerita" class="form-label">Penulis Berita</label>
                                        <input type="text" class="form-control" id="penulisBerita" name="penulis" value="{!! $data['penulis'] !!}"
                                            required readonly>
                                    </div>
