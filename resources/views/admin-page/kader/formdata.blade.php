<form id="form-lengkapi-data" method="POST" action="{{ url('/lengkapi-data/'.$user->id) }}">
    ...
    <div class="modal-body">
        ...
        <div class="mb-3">
            <label>NIK</label>
            <input type="number" name="nik" class="form-control" value="{{ $user->nik ?? '' }}" min="0" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
        </div>
        <!-- Tanggal Lahir & Umur -->
        <div class="row mb-3">
            <div class="col">
                <label>Tanggal Lahir</label>
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="{{ $user->tanggal_lahir ?? '' }}" onchange="hitungUmurOtomatis()">
            </div>
            <div class="col">
                <label>Umur</label>
                <input type="text" id="umur" name="umur" class="form-control" value="" readonly>
            </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="number" step="0.01" min="0" name="berat_badan_lahir" id="berat_badan_lahir" class="form-control"
                    value="{{ $user->berat_badan_lahir ?? '' }}" placeholder="Contoh: 3.2">
            </div>
            <div class="col">
                ...
                <input type="number" step="0.1" min="0" name="panjang_badan_lahir" id="panjang_badan_lahir" class="form-control"
                    value="{{ $user->panjang_badan_lahir ?? '' }}" placeholder="Contoh: 49">
            </div>
        </div>
        @endif
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="text" name="nama_ayah" id="nama_ayah" class="form-control" value="{{ $user->nama_ayah ?? '' }}">
            </div>
            <div class="col">
                <label for="nama_ibu">Nama Ibu</label>
                <input type="text" name="nama_ibu" id="nama_ibu" class="form-control" value="{{ $user->nama_ibu ?? '' }}">
            </div>
        </div>
        @endif
        <!-- Alamat -->
        ...
        <div class="mb-3">
            <label>No. HP</label>
            <input type="number" name="no_hp" class="form-control" value="{{ $user->no_hp ?? '' }}" min="0" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
        </div>
        ...
        @if(isset($user->level) && ($user->level === 'lansia' || $user->level === 'dewasa'))
            ...
            <div class="mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status_perkawinan" id="menikah" value="Menikah" {{ (isset($user->status_perkawinan) && $user->status_perkawinan == 'Menikah') ? 'checked' : '' }}>
                    <label class="form-check-label" for="menikah">Menikah</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="status_perkawinan" id="tidakmenikah" value="Tidak Menikah" {{ (isset($user->status_perkawinan) && $user->status_perkawinan == 'Tidak Menikah') ? 'checked' : '' }}>
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <label>RT</label>
                <input type="number" name="rt" class="form-control" value="{{ $user->rt ?? '' }}" min="0" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
            </div>
            <div class="col">
                <label>RW</label>
                <input type="number" name="rw" class="form-control" value="{{ $user->rw ?? '' }}" min="0" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
            </div>
        </div>
        <!-- Desa/Kelurahan/Nagari -->
        <div class="mb-3">
            <label for="kecamatan">Desa/Kelurahan/Nagari</label>
            <input type="text" name="kecamatan" id="kecamatan" class="form-control" value="{{ $user->kecamatan ?? '' }}">
        </div>
        <!-- Kecamatan -->
        <div class="mb-3">
            <label for="wilayah">Kecamatan</label>
            <input type="text" name="wilayah" id="wilayah" class="form-control" value="{{ $user->wilayah ?? '' }}">
        </div>
    ...
    <div class="mb-3">
        ...
        <div class="row">
            <div class="col-6 col-md-3">
                <input type="number" min="0" name="jarak_kehamilan_tahun" class="form-control" value="{{ $user->jarak_kehamilan_tahun ?? '' }}" placeholder="Tahun">
                <small class="text-muted">Tahun</small>
            </div>
            <div class="col-6 col-md-3">
                <input type="number" min="0" max="11" name="jarak_kehamilan_bulan" class="form-control" value="{{ $user->jarak_kehamilan_bulan ?? '' }}" placeholder="Bulan">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.1" min="0" name="berat_badan_ibu" id="berat_badan_ibu" class="form-control" value="{{ $user->berat_badan_ibu ?? '' }}" placeholder="Contoh: 55.5">
    </div>
    <!-- Hamil Anak Ke -->
    <div class="mb-3">
        <label for="hamil_ke">Hamil Anak Ke</label>
        <input type="number" min="1" name="hamil_ke" id="hamil_ke" class="form-control" value="{{ $user->hamil_ke ?? '' }}" placeholder="Contoh: 2">
    </div>
    <!-- Tinggi Badan (cm) -->
    <div class="mb-3">
        <label for="tinggi_badan_ibu">Tinggi Badan (cm)</label>
        <input type="number" step="0.1" min="0" name="tinggi_badan_ibu" id="tinggi_badan_ibu" class="form-control" value="{{ $user->tinggi_badan_ibu ?? '' }}" placeholder="Contoh: 160">
    </div>
@endif
    </div>
