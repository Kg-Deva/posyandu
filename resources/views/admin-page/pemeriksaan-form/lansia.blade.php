        ...
        btn.addEventListener('click', function () {
            ...
            fetch(`/skrining-tahunan-lansia/${userId}`)
                ...
                .then(html => {
                    ...
                    // ✅ Aktifkan <script> di dalam konten HTML hasil fetch
                    ...
                    if (modalEl) {
                        ...
                        // ✅ Hapus backdrop setelah close agar klik background aktif lagi
