                                    ...
                                    <div class="mb-0 opacity-90 fs-5">
                                        <div class="d-flex flex-column flex-md-row gap-2 gap-md-4">
                                            <div class="d-flex align-items-center">
                                                <span class="text-muted me-2 fw-normal">🧑‍🎓 Umur:</span>
                                                <span class="text-muted">{{ $pemeriksaanTerakhir ? $pemeriksaanTerakhir->umur . ' tahun' : $user->umur }}</span>
                                            </div>
                                            <div class="d-flex align-items-center">
                                                <span class="text-muted me-2 fw-normal">📋 NIK:</span>
