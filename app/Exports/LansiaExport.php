...
class LansiaExport implements FromCollection, WithHeadings, WithMapping, WithEvents, WithColumnFormatting
{
    protected $filters;
    ...
    {
        $query = PemeriksaanLansia::with('user');
    ...
    public function map($pemeriksaan): array
    {
        ...
        // ✅ AMBIL DATA DARI USER & PEMERIKSAAN LANSIA
        ...
        // ✅ USIA SAAT INI (FIX - AMBIL TAHUN PERTAMA AJA)
        $usia = '';
        // if (!empty($user->umur)) {
        //     // ✅ AMBIL ANGKA TAHUN PERTAMA SEBELUM KATA "TAHUN"
        //     if (preg_match('/^(\d+)\s*tahun/', $user->umur, $matches)) {
        //         $usia = $matches[1] . ' tahun';
        //     } else {
        //         // ✅ FALLBACK: AMBIL ANGKA PERTAMA AJA
        //         if (preg_match('/^(\d+)/', $user->umur, $matches)) {
        //             $usia = $matches[1] . ' tahun';
        //         }
        //     }
        // }
        ...
        // ✅ DATA PENGUKURAN (dari PemeriksaanLansia)
        ...
        // ✅ DATA SKRINING KESEHATAN (dari PemeriksaanLansia)
        ...
        $rujuk = 'TIDAK';
        // ✅ KALAU ADA FIELD RUJUK DI DATABASE NANTI TINGGAL UNCOMMENT:
        // if (!empty($pemeriksaan->rujuk) && trim($pemeriksaan->rujuk) !== '') {
        //     $rujuk = 'YA';
        // }
        ...
        return [
            ...
            $tglLahir,              // TGL LAHIR
            $usia,                  // USIA SAAT INI (FIX: "26 tahun")
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // MERGE GRUP PEMERIKSAAN SKRINING KESEHATAN (V1:AE1) ✅ UPDATE JADI 10 KOLOM
                $sheet->mergeCells('V1:AE1');  // PEMERIKSAAN SKRINING KESEHATAN

                // MERGE KOLOM TUNGGAL EDUKASI & RUJUK (AF1:AG1) ✅ UPDATE POSISI
                $sheet->mergeCells('AF1:AF2');  // EDUKASI
                $sheet->mergeCells('AG1:AG2');  // RUJUK

                // ✅ STYLING HEADER UTAMA (BARIS 1) - UPDATE JADI AG (32 KOLOM)
                ...
                // ✅ STYLING SUB-HEADER (BARIS 2) - UPDATE JADI AE (TANPA YA/TIDAK YANG REDUNDANT)
                ...
                // ✅ BORDER UNTUK SEMUA DATA - UPDATE JADI AG (32 KOLOM)
                ...
                // ✅ SET WIDTH KOLOM - UPDATE JADI 32 KOLOM
                ...
                // ✅ ALIGNMENT DATA ROWS - UPDATE JADI AG (32 KOLOM)
                ...
                // ✅ ALIGNMENT ANGKA (CENTER) - UPDATE JADI AG
